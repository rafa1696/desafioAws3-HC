...
![Página inicial móvel](./assets/home-movel.png)

#### 1.1.1 - Menu móvel
![Menu da versão móvel](./assets/menu-movel.png)
### 1.2 - Busca

#### 1.2.1 - Busca Móvel
![Campo de busca na versão móvel](./assets/busca-movel.png)
## 2 - Página de buscas
![Página de pesquisa desktop](./assets/pesquisa-desktop.png)

### 2.1 - Página de buscas móvel
![Página de pesquisa na versão móvel](./assets/pesquisa-movel.png)
